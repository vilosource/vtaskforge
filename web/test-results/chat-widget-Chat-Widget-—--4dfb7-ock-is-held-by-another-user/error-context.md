...
- Name: chat-widget.spec.ts >> Chat Widget — Error States (mocked bridge) >> shows conflict message when lock is held by another user
- Location: e2e/chat-widget.spec.ts:240:3
